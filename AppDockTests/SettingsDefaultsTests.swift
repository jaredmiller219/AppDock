...
final class SettingsDefaultsTests: XCTestCase {
    ...
    func testDefaultsDictionary_matchesExpectedValues() {
        ...
        XCTAssertEqual(values[SettingsDefaults.accentColorKey] as? String, SettingsDefaults.accentColorDefault)
    ...
    func testRestoreWritesDefaultsToUserDefaults() {
        ...
        XCTAssertEqual(defaults.string(forKey: SettingsDefaults.accentColorKey), SettingsDefaults.accentColorDefault)
