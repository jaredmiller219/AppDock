...
- `features.md`: highlights, glossary, and interaction behavior.
- `usage.md`: run, settings, and manual testing flows.
- `architecture.md`: state, data model, and runtime flow.
- `testing.md`: unit/UI guidance and test matrix.
