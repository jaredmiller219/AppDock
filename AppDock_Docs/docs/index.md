...
- [Features](features.md): highlights, glossary, and interaction behavior.
- [Usage](usage.md): run, settings, and manual testing flows.
- [Architecture](architecture.md): state, data model, and runtime flow.
- [Testing](testing.md): unit/UI guidance and test matrix.
- [Troubleshooting](troubleshooting.md): common issues and fixes.
- [Reference](reference.md): project layout, docs workflow, and file map.
